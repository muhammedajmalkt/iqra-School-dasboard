...
//                   href={href}
//                   key={item.label}
//                   className={`group flex items-center justify-center lg:justify-start gap-4 py-2.5 px-3 rounded-lg transition-all duration-200  ${
//                     active
//                       ? " border-l-4 bg-blue-700/10 border-blue-700  rounded-none  "
...
//                     }`}
//                   />
//                   <span className={`hidden lg:block font-medium transition-all duration-200 ${
//                     active 
